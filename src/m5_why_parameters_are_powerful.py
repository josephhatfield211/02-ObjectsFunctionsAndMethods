...
def main():
    ...
    #better_draw_circles(rg.Point(100,50), 1000)
    #better_draw_circles(rg.Point(-200,0), 1000)

    #even_better_draw_circles(rg.Point(100, 50), 10, 111, "red", 1)
    #even_better_draw_circles(rg.Point(-200,0), 10, 111, "red", 1)
...
def better_draw_circles(point, number):
    """
...
def even_better_draw_circles(point, rad, circs, color, thicc):
    ...
    for k in range(1, (circs + 1)):  # k becomes 1, 2, 3, ... 10
